...
if K.backend() == 'theano':
    import semseg_keras.util.theano_backend as K_BACKEND
else:
    import semseg_keras.util.tensorflow_backend as K_BACKEND
...
if __name__ == '__main__':
    ...
    # input = misc.imread('../../data/CamVid/test/0001TP_008550.png')
    ...
    model = DenseNetFCN((image_height, image_width, image_channel), growth_rate=16, nb_layers_per_block=[4, 5, 7, 10, 12, 15], upsampling_type='deconv')
    # model = DenseNet((32, 32, 3), depth=100, nb_dense_block=3, growth_rate=12, bottleneck=True, reduction=0.5, weights=None)
    # model.summary()
    ...
    # print(output.shape)
    # misc.imsave('/tmp/densenet_fcn.png', output)
